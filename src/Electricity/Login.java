...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        tf1.setBounds(400, 20, 150, 23);
        add(tf1);
        pf2 = new JPasswordField(15);
        pf2.setBounds(400, 60, 150, 23);
        add(pf2);
        ...
        b1.setBounds(330, 160, 100, 24);
        add(b1);
        
        ImageIcon ic2 = new ImageIcon(ClassLoader.getSystemResource("icon/cancel.jpg"));
        Image i2 = ic2.getImage().getScaledInstance(16, 14,Image.SCALE_DEFAULT);
        b2 = new JButton("Cancel",new ImageIcon(i2));
        b2.setBounds(450, 160, 100, 24);
        add(b2);
        ...
        ImageIcon ic3 = new ImageIcon(ClassLoader.getSystemResource("icon/second.gif"));
        Image i3 = ic3.getImage().getScaledInstance(240, 150,Image.SCALE_DEFAULT);
