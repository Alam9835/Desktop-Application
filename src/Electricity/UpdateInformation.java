...
public class UpdateInformation extends JFrame implements ActionListener{
    ...
    UpdateInformation(String meter){
        ...
        l1.setBounds(30, 70, 100, 23);
        add(l1);
        
        l11 = new JLabel();
        l11.setBounds(230, 70, 200, 23);
        add(l11);
         
        
        JLabel l2 = new JLabel("Meter Number");
        l2.setBounds(30, 110, 100, 23);
        add(l2);
        
        l12 = new JLabel();
        l12.setBounds(230, 110, 200, 23);
        add(l12);
        
        JLabel l3 = new JLabel("Address");
        l3.setBounds(30, 150, 100, 23);
        add(l3);
        
        t1 = new JTextField();
        t1.setBounds(230, 150, 200, 23);
        add(t1);
        
        JLabel l4 = new JLabel("City");
        l4.setBounds(30, 190, 100, 23);
        add(l4);
        
        t2 = new JTextField();
        t2.setBounds(230, 190, 200, 23);
        add(t2);
        
        JLabel l5 = new JLabel("State");
        l5.setBounds(30, 230, 100, 23);
        add(l5);
        
        t3 = new JTextField();
        t3.setBounds(230, 230, 200, 23);
        add(t3);
        
        JLabel l6 = new JLabel("Email");
        l6.setBounds(30, 270, 100, 23);
        add(l6);
        
        t4 = new JTextField();
        t4.setBounds(230, 270, 200, 23);
        add(t4);
        
        JLabel l7 = new JLabel("Phone");
        l7.setBounds(30, 310, 100, 23);
        add(l7);
        
        t5 = new JTextField();
        t5.setBounds(230, 310, 200, 23);
        add(t5);
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("icon/update.gif"));
